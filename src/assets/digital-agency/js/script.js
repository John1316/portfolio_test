...
$(".btn_up").on('click', function(e) {
  ...
  if ($(window).width() > 991) {
    $(".banner .main_slider_content, header , .team-details , .service-details " ).mousemove(function (e) {
    ...
    $(".skill-details .title" ).mousemove(function (e) {
      $("[data-depth]").each(function () {
        ...
        $(this).css({
          transform:
            "translate3d(" + amountMovedX + "px," + -9 + "px, 0)",
        });
      });
    });
    ...
    $(".navbar-brand img" ).mousemove(function (e) {
      $("[data-depth]").each(function () {
        ...
        $(this).css({
          transform:
            "translate3d(" + amountMovedX + "px," + 8 + "px, 0)",
        });
      });
    });
  }
